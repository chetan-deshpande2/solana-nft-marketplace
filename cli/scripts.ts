...
export const updateFee = async (solFee: number, tokenFee: number) => {
...
export const depositEscrow = async (sol: number, token: number) => {
...
export const withdrawEscrow = async (sol: number, token: number) => {
  let userAddress = payer.publicKey;
  console.log(userAddress.toBase58(), sol, token);
...
export const purchase = async (mint: PublicKey, byToken: boolean) => {
